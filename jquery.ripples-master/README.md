...
The main part of the solution is to make the whole thing in the main specific paragraph and once when the whole thing is perturbed the whole stuff is saved into the paragraph phile 
Options
-------
